...
class FlyformerPretrainer(Trainer):
    def __init__(self, *args, **kwargs):
        data_collator = kwargs.get("data_collator",None)
        token_dictionary = kwargs.pop("token_dictionary")

        if data_collator is None:
            precollator = FlyformerPreCollator(token_dictionary=token_dictionary)
        ...
        if example_lengths_file:
            ...
            raise Exception(
                "example_lengths_file is required (list in pickle format)"
            )
